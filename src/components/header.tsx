    ...
    <header className="bg-gray-800 text-white p-4 flex justify-between items-center">
      ...
      <form onSubmit={handleSearch} className="relative w-full max-w-sm group">
        ...
        <div className="relative flex items-center">
          ...
          />
          {query.length === 0 && (
            <kbd className="absolute right-2.5 top-1/2 -translate-y-1/2 hidden h-5 select-none items-center gap-1 rounded border border-gray-600 bg-gray-700 px-1.5 font-mono text-[10px] font-medium text-gray-400 sm:flex group-focus-within:opacity-0 transition-opacity">
